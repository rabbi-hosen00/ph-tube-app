...
console.log("video script loded")

//1. Fetch, load and show Categorirs on html
...
// load categories videos depends on button
...
// video details display function
...
const displayVideos = (videos) => {
    ...
    if (videos.length === 0){
        ...
        <div class=" min-h-[300px] w-full flex flex-col justify-center items-center">
          ...
          No Content Here in this Categroy
          </h2>
        </div>
        `
        return;
    ...
    videos.map((video) => {
        ...
        card.innerHTML = `
             ...
             <img
               ...
               alt="Shoes" />
               ${
                video.others.posted_date?.length === 0 ? "" : `<span class=" absolute text-sm right-2 bottom-2 bg-black text-white rounded p-1">
...
// Create DisplayCatgories
const displayCatgories = (categories) => {
